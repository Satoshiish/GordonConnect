...
const Forum = () => {
  ...
  const handleCommentSubmit = async (forum_id) => {
    ...
    try {
      await makeRequest.post(`/forums/${forum_id}/comments`, {
  ...
  useEffect(() => {
    if (forums.length > 0 && currentUser) {
      ...
      console.log(
        "Should show delete?",
        currentUser.id === forums[0].user_id || isAdmin
      );
    }
                    ...
                    {expandedForums[forum.forum_id] && (
                      <>
                        ...
                        >
                          ...
                          <div
                            className={`space-y-6 mt-8 pt-8 border-t ${
                              theme === "dark"
                                ? "border-gray-700/50"
                                : "border-gray-200"
                            }`}
                            ...
                            <div className="mt-8">
                              ...
                              <div className="flex justify-end mt-4">
                                <motion.button
                                  ...
                                  whileTap={{ scale: 0.98 }}
                                  onClick={() =>
                                    handleCommentSubmit(forum.forum_id)
                                  }
                                  disabled={
                                    !newComment[forum.forum_id]?.trim() ||
                                    !canComment
                                  }
          ...
          >
            ...
            >
              ...
              <p className="mb-8 text-gray-700 dark:text-gray-300">
                Are you sure you want to delete this discussion? All comments
